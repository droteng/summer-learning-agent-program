...
- Downloadable Markdown and JSON report package exports are generated through `app/api/report-download` from the same parent-approved printable report package.
