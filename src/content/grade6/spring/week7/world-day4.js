// Grade 6 World/Current Affairs — Spring Expedition, Week 7 (Voices for the
...
export const springG6WorldW7D4 = {
  id: "g6.spring.world.w7.d4",
  season: "spring",
  gradeLevel: 6,
  weekNumber: 7,
  dayNumber: 4,
  ...
  standardsRefs: ["C3.D2.Geo.6", "C3.D2.Civ.10"],
  hook: "Spring reminds us the Earth can renew itself — but only if we help. Around the world, communities face pollution, habitat loss, and shortages of clean water. Today you explore these global issues and, more importantly, how ordinary people are fighting back.",
  miniLesson: [
    "Pollution is harmful stuff added to air, water, or land — like smog over a city, plastic in the ocean, or chemicals in a river. It crosses borders: air and water carry it far from where it started.",
    "Habitat loss happens when the places animals and plants live are destroyed — forests cut down, wetlands drained, coral reefs dying. It is a leading cause of species becoming endangered.",
    "Clean water is not guaranteed everywhere. Many communities lack safe drinking water because of pollution, drought, or old pipes. But communities respond: planting trees, cleaning rivers, banning plastics, and building wells and filters."
  ],
  workedExample: {
    prompt: "A coastal town's fishing catch is shrinking and the beach is covered in plastic. Identify the issue and one way the community could respond.",
    steps: [
      ...
      "Choose a community response: organize regular beach clean-ups and reduce plastic use.",
      "Result: plastic pollution is the issue; the community can run clean-ups and ban single-use plastics."
    ],
    answer: "The issue is plastic pollution harming the ocean; the community can respond with beach clean-ups and by reducing single-use plastic."
  },
  items: [
    {
      id: "g6.spring.world.w7.d4.q1",
      ...
      answerIndex: 0,
      explanation: "Smog is harmful particles and gases in the air — that is air pollution.",
      hintLadder: [
    ...
    },
    {
      ...
      answerIndex: 1,
      explanation: "Destroying the forest removes the home of the species that lived there — habitat loss, a major cause of endangered species.",
      hintLadder: [
    ...
    },
    {
      ...
      rubric: {
        level3: "Clearly describes one real environmental issue AND gives a realistic, relevant community response that would actually help address it.",
      ...
      exemplar: "Many communities lack clean water because rivers are polluted. A community could respond by building simple water filters and passing rules to stop factories from dumping waste in the river.",
      hintLadder: [
    ...
    {
      id: "g6.spring.world.w7.d4.q5",
      type: "short_answer",
      stem: "Why do environmental problems like pollution often affect people far away from where they started? Give one example.",
      rubric: {
        level3: "Explains that air and water move across borders, carrying pollution far away AND gives a fitting example (river carrying waste downstream, ocean currents moving plastic, wind carrying smog).",
        level2: "Gives a partial explanation OR an example, but not a clear connection between them.",
        level1: "Restates the question or gives no real reason."
      },
      exemplar: "Air and water keep moving, so they carry pollution far from the source. For example, plastic dumped in one country's river can float on ocean currents and wash up on a beach thousands of miles away.",
      hintLadder: [
  ...
  dailyHour: {
    ...
    challengeArena: {
      ...
      items: [
        {
          id: "g6.spring.world.w7.d4.arena1",
          type: "multiple_choice",
          stem: "Coral reefs around the world are dying, leaving thousands of fish species without a home. This is mainly an example of:",
          choices: [
          ...
          answerIndex: 3,
          explanation: "Reefs are the home (habitat) of many ocean species; when reefs die, those species lose their habitat — habitat loss.",
          hintLadder: [
        ...
        {
          id: "g6.spring.world.w7.d4.arena2",
          type: "short_answer",
          ...
          rubric: {
            level3: "Correctly names the issue (water pollution / clean-water threat) AND gives two distinct, realistic community responses (e.g., pass rules to stop dumping, clean the river, build filters, protest, test the water).",
          ...
          exemplar: "This is water pollution threatening their clean water. The community could push for a law banning the factory from dumping, and they could organize volunteers to test and clean the river.",
          hintLadder: [
            "What part of the environment is being harmed — and what does the community rely on it for?",
            "Think of one rule or law they could push for.",
    ...
    reflectAndReward: {
      ...
      badge: { id: "spring-global-earth-reporter", name: "Global Earth Reporter", emoji: "🌏" },
      estimatedMinutes: 7
    }
  }
};
