...
const AUTHORED_WEEKS = {
  ...
  // Grade 5 rollout begins with Summer (its Grade 5 counterpart of the Grade 6
  // Summer arc). GRADE_STATUS[5] stays "in_development" until its other seasons
  // are authored — an honest per-program status.
